...
public class REQ03AtualizarLivroTSTests {
  ...
  @Test
  public void AtualizarLivroTSTests() {
    ...
    try {
    	...
    	HomePage logado = login.loginUsuarioValido("maria", "456");
    	
        LivroPage livro = new LivroPage(driver);
        
        livro.atualizaLivro("2222", "TESTE", "TESTE UPDATE");
